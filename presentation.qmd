...
## Software for version control {.textcenter}
...
As most users will be on Windows, we will focus on [Command Prompt]{.text-color-highlight-primary} here. You can can open it by typing [`cmd`]{.text-color-highlight-secondary} in the Windows search bar. 

## Installation

Is [Git]{.text-color-highlight-primary} already installed?

Open Command Prompt and check your [version]{.text-color-highlight-secondary}:
...
Navigate to the slides for your chosen GUI client!
...
[**R-studio**]{.text-color-highlight-primary} is using [Projects]{.text-color-highlight-secondary}, which are a way to organize your work in RStudio.
